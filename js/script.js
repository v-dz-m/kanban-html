...
function dragStart() {
    ...
    switch (this.parentElement.id) {
        case 'created':
            this.firstElementChild.classList.remove('created');
            break;
        case 'todo':
        ...
        case 'doing':
            ...
            break;
        case 'testing':
            this.firstElementChild.classList.remove('testing');
            break;
        case 'done':
...
function dragEnd() {
    ...
    switch (this.parentElement.id) {
        case 'created':
            this.firstElementChild.classList.add('created');
            break;
        case 'todo':
        ...
        case 'doing':
            ...
            break;
        case 'testing':
            this.firstElementChild.classList.add('testing');
            break;
        case 'done':
